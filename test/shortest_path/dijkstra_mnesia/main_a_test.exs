defmodule ShortestPath.DijkstraMnesia.MainATest do
  use ExUnit.Case
  doctest ShortestPath.DijkstraMnesia.MainA
  alias ShortestPath.DijkstraMnesia.MainA
  ...
  test "solve sample_01 by Dijkstra" do
    test_case("sample_01.txt", MainA, MainA)
  end

  test "solve sample_02 by Dijkstra" do
    test_case("sample_02.txt", MainA, MainA)
  end
end
